...
class Ui_Mainform(object):
    def setupUi(self, Mainform):
        ...
        self.logname   = QLineEdit(self.lFr)
        self.logpassLb = QLabel(self.lFr)
        self.logpass   = QLineEdit(self.lFr)
        self.logokPb   = QPushButton(self.lFr)
        self.lognameLb.setGeometry(20, 73, 102, 19)
        self.logname.setGeometry(160, 72, 151, 21)
        self.logpassLb.setGeometry(20, 114, 94, 19)
        self.logpass.setGeometry(160, 113, 151, 21)
        self.logokPb.setGeometry(145, 160, 84, 30)
        self.logname.setMaxLength(25)
        self.logpass.setMaxLength(25)
        self.logpass.setEchoMode(1) # QLineEdit.NoEcho
        self.lognameLb.setBuddy(self.logname)
        self.logpassLb.setBuddy(self.logpass)
        #devel:
        self.lFr.hide()
        # Mainform further
