...
-- (10, 'Porcine',      'i', TRUE),
-- (11, 'Camelid',      'd', TRUE),
-- (12, 'Other mammal', 't', TRUE),
-- (13, 'Fowl',         'g', TRUE),
-- (14, 'Raptor',       'w', FALSE),
-- (15, 'Exotic avian', 'x', TRUE),
-- (16, 'Fish',         's', TRUE),
-- (17, 'Amphibian',    'h', FALSE),
-- (18, 'Reptile',      'y', FALSE),
-- (19, 'Insect',       'n', FALSE), 
-- (20, 'Spider',       'z', FALSE);
-- new:
...
--insert into ptypes (pt_id,pt_name,pt_markup) values
-- (1,'other',2),(2,'med',2),(3,'serv',1),(4,'good',2),(5,'food',2),(6,'cons',1),(7,'hist',1),(8,'vacc',2);
...
(1,'Amoxicillin Injectable','amoxi1','med',TRUE,0.12,3,FALSE,1),
(2,'Amoxicillin Injectable 50 ml','amoxib','med',TRUE,5.96,9,TRUE,2),
(3,'Amoxicillin Tablets 50 mg','amoxit50','med',TRUE,0.12,1,TRUE,2),
(4,'Amoxicillin Tablets 100 mg','amoxit100','med',TRUE,0.22,1,TRUE,2),
(5,'Amoxicillin Tablets 250 mg','amoxit250','med',TRUE,0.43,1,TRUE,2),
(6,'Antirobe Capsules 25 mg','antir25','med',TRUE,0.60,1,TRUE,2),
(7,'Antirobe Capsules 75 mg','antir75','med',TRUE,1.70,1,TRUE,2),
(8,'Antirobe Capsules 150 mg','antir150','med',TRUE,3.23,1,TRUE,2),
(9,'Antirobe Capsules 300 mg','antir300','med',TRUE,6.30,1,TRUE,2),
(10,'Baytril Injectable 2.5 %','baytri2.5','med',TRUE,0.49,3,FALSE,1),
(11,'Baytril Injectable 5 %','baytri5','med',TRUE,0.95,3,FALSE,1),
(12,'Baytril Injectable 10 %','baytri10','med',TRUE,1.67,3,FALSE,1),
(13,'Betamox Injectable','betamoxi','med',TRUE,0.20,3,FALSE,1),
(14,'Betamox Injectable 50 ml','betamoxib','med',TRUE,9.70,9,TRUE,2),
(15,'Buster Collar 25 cm','collar25','god',FALSE,10.21,12,FALSE,1),
(16,'Choo-Bone XL','choobonexl','god',FALSE,1.28,12,FALSE,2),
(17,'Dexafort Injection','dexaf','med',TRUE,0.41,3,FALSE,1),
(18,'Drontal Plus Palatable Canine','drontppc','med',FALSE,1.19,1,TRUE,2),
(19,'Duramune DAPPi+L','ddappil','med',TRUE,6.81,13,FALSE,2),
(20,'Duramune DAPPi+LC','ddappilc','med',TRUE,8.17,13,FALSE,2),
(21,'Eurican DHPPi+LC','edhppilc','med',TRUE,8.51,13,FALSE,2),
(22,'Felimazole 2.5 mg','felimaz2.5','med',TRUE,1.50,1,TRUE,2),
(23,'Fevaxyn Pentofel','fpento','med',TRUE,8.51,13,FALSE,2),
(24,'Fevaxyn iCHPChlam','fichpch','med',TRUE,6.81,13,FALSE,2),
(25,'Frontline Spray 100 ml','frontl100','med',FALSE,7.23,9,TRUE,2),
(26,'Frontline Spray 250 ml','frontl250','med',FALSE,13.62,9,TRUE,2),
(27,'Hills Feline Growth 1.8 kg','hfgr1.8','fod',FALSE,5.96,10,TRUE,2),
(28,'Marbocyl Injectable 2.5 %','marboi2.5','med',TRUE,0.27,3,FALSE,1),
(29,'Nobivac KC','nkc','med',TRUE,13.62,13,FALSE,2),
(30,'Nobivac Myxo','nmyxo','med',TRUE,4.26,13,FALSE,2),
(31,'Nobivac Rabies','nrab','med',TRUE,12.77,13,FALSE,2),
(32,'Oral Hygiene Rinse','oralhy','med',FALSE,4.26,9,TRUE,1),
(33,'ProteqFlu','proteqf','med',TRUE,7.66,13,FALSE,2),
(34,'ProteqFlu Te','proteqft','med',TRUE,10.21,13,FALSE,2),
(35,'Vicryl 5-0 mounted','vicryl50m','med',TRUE,2.98,12,FALSE,1),
(36,'VitBee 1000 Injectable','vitbee1k','med',TRUE,0.48,3,FALSE,1),
(37,'Consultation','constd','con',FALSE,20.00,15,FALSE,1),
(38,'Consultation Follow-Up','con2','con',FALSE,14.89,15,FALSE,1),
(39,'Consultation Further Follow-Up','conff','con',FALSE,9.79,15,FALSE,1),
(40,'Consultation Free','confree','con',FALSE,0.00,15,FALSE,1),
(41,'Consultation Child Pet','conchpet','con',FALSE,6.38,15,FALSE,1),
(42,'Consultation Exotic','conexot','con',FALSE,23.40,15,FALSE,1),
(43,'Consultation Out of Hours 1 ( 7 pm to 10 pm)','conooh1','con',FALSE,28.51,15,FALSE,1),
(44,'Consultation Out of Hours 2 (10 pm to  0 am)','conooh2','con',FALSE,37.87,15,FALSE,1),
(45,'Consultation Out of Hours 3 ( 0 am to  7 am)','conooh3','con',FALSE,47.23,15,FALSE,1),
(46,'Consultation Out of Hours 4 (Sat 5 pm to Mon 7 am)','conooh4','con',FALSE,56.68,15,FALSE,1),
(47,'Castr. Canine S (< 10 kg)','castc1','srv',FALSE,34.04,15,FALSE,1),
(48,'Castr. Canine M (< 20 kg)','castc2','srv',FALSE,51.06,15,FALSE,1),
(49,'Castr. Canine L (< 50 kg)','castc3','srv',FALSE,68.09,15,FALSE,1),
(50,'Castr. Canine XL (<100 kg)','castc4','srv',FALSE,85.11,15,FALSE,1),
(51,'Castr. Canine XXL (>100 kg)','castc5','srv',FALSE,119.15,15,FALSE,1),
(52,'Castr. Feline','castf','srv',FALSE,25.53,15,FALSE,1),
(53,'Castr. Lagomorph/Rodent','castr','srv',FALSE,35.74,15,FALSE,1),
(54,'Spay Canine S   (< 10 kg)','spaycs','srv',FALSE,51.06,15,FALSE,1),
(55,'Spay Canine M   (< 20 kg)','spaycm','srv',FALSE,68.09,15,FALSE,1),
(56,'Spay Canine L   (< 50 kg)','spaycl','srv',FALSE,85.11,15,FALSE,1),
(57,'Spay Canine XL  (<100 kg)','spaycxl','srv',FALSE,119.15,15,FALSE,1),
(58,'Spay Canine XXL (>100 kg)','spaycxxl','srv',FALSE,153.19,15,FALSE,1),
(59,'Spay Feline','spayf1','srv',FALSE,42.55,15,FALSE,1),
(60,'Spay Feline Pregnant','spayf2','srv',FALSE,51.06,15,FALSE,1),
(61,'Spay Feline Season','spayf3','srv',FALSE,68.09,15,FALSE,1),
(62,'Spay Rabbit/Rodent','spayr','srv',FALSE,25.53,15,FALSE,1),
(63,'Euthanasia Canine S   (< 10 kg)','euthcs','srv',FALSE,29.79,15,FALSE,1),
(64,'Euthanasia Canine M   (< 20 kg)','euthcm','srv',FALSE,38.30,15,FALSE,1),
(65,'Euthanasia Canine L   (< 50 kg)','euthcl','srv',FALSE,55.32,15,FALSE,1),
(66,'Euthanasia Canine XL  (<100 kg)','euthcxl','srv',FALSE,72.34,15,FALSE,1),
(67,'Euthanasia Canine XXL (>100 kg)','euthcxxl','srv',FALSE,89.36,15,FALSE,1),
(68,'Euthanasia Feline','euthf','srv',FALSE,25.53,15,FALSE,1),
(69,'Euth./Body Disposal Canine S   (< 10 kg)','euthcsb','srv',FALSE,4.26,15,FALSE,1),
(70,'Euth./Body Disposal Canine M   (< 20 kg)','euthcmb','srv',FALSE,8.52,15,FALSE,1),
(71,'Euth./Body Disposal Canine L   (< 50 kg)','euthclb','srv',FALSE,12.78,15,FALSE,1),
(72,'Euth./Body Disposal Canine XL  (<100 kg)','euthcxlb','srv',FALSE,17.04,15,FALSE,1),
(73,'Euth./Body Disposal Canine XXL (>100 kg)','euthcxxlb','srv',FALSE,25.60,15,FALSE,1),
(74,'Euth./Body Disposal Feline','euthfb','srv',FALSE,4.26,15,FALSE,1),
(75,'Euth./Individual Cremation','euthind','srv',FALSE,0.00,15,FALSE,1),
(76,'Injection s.c.','injsc','srv',FALSE,1.91,15,FALSE,1),
(77,'Injection i.m.','injim','srv',FALSE,2.77,15,FALSE,1),
(78,'Injection i.v.','injiv','srv',FALSE,6.17,15,FALSE,1),
(79,'Injection i.a.','injia','srv',FALSE,13.40,15,FALSE,1),
(80,'Injection i.v. Catheter','injivc','srv',FALSE,8.51,15,FALSE,1),
(81,'Anal Gland Emptying during Consultation','ag1','srv',FALSE,6.81,15,FALSE,1),
(82,'Anal Gland Emptying (only)','ag2','srv',FALSE,10.64,15,FALSE,1),
(83,'Tablet Administration','tab1','srv',FALSE,0.85,15,FALSE,1),
(84,'Tablet Administration difficult','tab2','srv',FALSE,2.55,15,FALSE,1),
(85,'Dispense Fee','disp','srv',FALSE,0.85,15,FALSE,1),
(86,'Dispense Fee Out of Hours 1 ( 7 pm to 10 pm)','dispo1','srv',FALSE,2.13,15,FALSE,1),
(87,'Dispense Fee Out of Hours 2 (10 pm to  0 am)','dispo2','srv',FALSE,4.26,15,FALSE,1),
(88,'Dispense Fee Out of Hours 3 ( 0 am to  7 am)','dispo3','srv',FALSE,6.38,15,FALSE,1),
(89,'Dispense Fee Out of Hours 4 (Sat 5 pm to Non 7 am)','dispo4','srv',FALSE,8.52,15,FALSE,1),
(90,'Dressing S','dress','srv',FALSE,2.13,15,FALSE,1),
(91,'Dressing M','dresm','srv',FALSE,4.26,15,FALSE,1),
(92,'Dressing L','dresl','srv',FALSE,8.52,15,FALSE,1),
(93,'Clip nails','clipn','srv',FALSE,4.26,15,FALSE,1),
(94,'Clip nails (only)','clipno','srv',FALSE,8.52,15,FALSE,1),
(95,'Clip beak and nails','clipbn','srv',FALSE,11.91,15,FALSE,1),
(96,'Ear cleaning','ears','srv',FALSE,8.26,15,FALSE,1),
(97,'Dental Scaling and Polishing Feline incl. Anaesth.','dentf','srv',FALSE,68.09,15,FALSE,1),
(98,'Dental Scaling and Polishing Canine S   (< 10 kg)','dentcs','srv',FALSE,68.09,15,FALSE,1),
(99,'Dental Scaling and Polishing Canine M   (< 20 kg)','dentcm','srv',FALSE,85.11,15,FALSE,1),
(100,'Dental Scaling and Polishing Canine L   (< 50 kg)','dentcl','srv',FALSE,102.13,15,FALSE,1),
(101,'Dental Scaling and Polishing Canine XL  (<100 kg)','dentcxl','srv',FALSE,119.15,15,FALSE,1),
(102,'Dental Scaling and Polishing Canine XXL (>100 kg)','dentcxxl','srv',FALSE,136.17,15,FALSE,1),
(103,'Dental Extraction','dentx','srv',FALSE,4.26,15,FALSE,1),
(104,'Dental Extraction Complicated','dentxc','srv',FALSE,11.91,15,FALSE,1),
(105,'Grooming per 10 min','groom','srv',FALSE,4.68,15,FALSE,1),
(106,'General Anaesthesia Feline per 10 min','anesf','srv',FALSE,8.52,15,FALSE,1),
(107,'General Anaesthesia Canine < 10 kg per 10 min','anesc1','srv',FALSE,8.52,15,FALSE,1),
(108,'Surgical Time per 10 min','surgt1','srv',FALSE,25.53,15,FALSE,1),
(109,'Professional Time per 10 min','proft1','srv',FALSE,17.02,15,FALSE,1),
(110,'Ultrasound Scan Time per 10 min','uss1','srv',FALSE,34.04,15,FALSE,1),
(111,'Urinalysis Dip-Stick','ur1','srv',FALSE,4.26,15,FALSE,1),
(112,'Urinalysis microscopic crystals','ur2','srv',FALSE,6.81,15,FALSE,1),
(113,'Urinalysis microscopic cytology','ur3','srv',FALSE,12.77,15,FALSE,1),
(114,'Visit within 20 miles','visit1','srv',FALSE,34.04,15,FALSE,1),
(115,'Visit per extra mile','visit2','srv',FALSE,0.68,15,FALSE,1),
(116,'Xray 1st Plate','xray1','srv',FALSE,29.79,15,FALSE,1),
(117,'Xray 2nd Plate','xray2','srv',FALSE,21.28,15,FALSE,1),
(118,'Xray 3rd Plate','xray3','srv',FALSE,12.77,15,FALSE,1),
(119,'Xray Same Plate 1 more Exposure','xray4','srv',FALSE,4.26,15,FALSE,1),
(120,'Tel. advice per 10 min','tel1','srv',FALSE,12.77,15,FALSE,1),
(121,'Hospitalisation Feline per night','hosf','srv',FALSE,4.26,15,FALSE,1),
(122,'Hospitalisation Canine S   (< 10 kg) per night','hoscs','srv',FALSE,4.26,15,FALSE,1),
(123,'Hospitalisation Canine M   (< 20 kg) per night','hoscm','srv',FALSE,6.81,15,FALSE,1),
(124,'Hospitalisation Canine L   (< 50 kg) per night','hoscl','srv',FALSE,10.21,15,FALSE,1),
(125,'Hospitalisation Canine XL  (<100 kg) per night','hoscxl','srv',FALSE,12.77,15,FALSE,1),
(126,'Hospitalisation Canine XXL (>100 kg) per night','hoscxxl','srv',FALSE,17.02,15,FALSE,1),
(127,'Repeat Prescription','reppre','srv',FALSE,4.26,15,FALSE,1),
(128,'Died naturally','diednat','oth',FALSE,0.00,15,FALSE,null),
(129,'Dead On Arrival','doa','oth',FALSE,0.00,15,FALSE,null),
...
(164,'Vacc. Tetanol','tet','med',TRUE,10.21,13,FALSE,1),
(165,'Vacc. Prevacun FT','prevacft','med',TRUE,10.21,13,FALSE,1),
(166,'Vacc. EHV1','ehv','med',TRUE,17.02,13,FALSE,1),
(167,'Vacc. Cylap','cylap','med',TRUE,8.52,13,FALSE,1),
(168,'Vacc. Nobivac Puppy P','nobipupp','med',TRUE,10.21,13,FALSE,1),
(169,'Onsior Tablets 80 mg','onsior80','med',TRUE,1.19,1,TRUE,2),
(170,'Vacc. Feline4 1st incl 2nd','vacf41','vac',TRUE,25,13,FALSE,1),
(171,'Drop Administration','drop','srv',FALSE,0.85,15,FALSE,1);
