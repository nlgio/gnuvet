...
class Ui_Saecli(object):
    def setupUi(self, Saecli):
        ...
        ## self.clist = QTableWidget(self.matchFr)
        ...
        #self.clist.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ##self.clist.setTabKeyNavigation(False)
        self.matchFr.hide()
        ## self.clist.setSelectionMode(QAbstractItemView.SingleSelection)
        ## self.clist.setSelectionBehavior(QAbstractItemView.SelectRows)
        ## self.clist.setCornerButtonEnabled(False)
        ## self.clist.setColumnCount(0)
        ## self.clist.setRowCount(0)
        ## self.clist.verticalHeader().setVisible(False)
        ## self.clist.verticalHeader().setHighlightSections(False)
